...
public class BerkeleyDBUtil {
    ...
    public BerkeleyDBUtil(String homeDirectory) throws DatabaseException {
     ...
     * 遍历数据库中的所有记录，返回list
     */
    public ArrayList<String> getEveryItem() throws DatabaseException {
     ...
     * 根据key值删除数据库中的一条记录
     */
    public boolean deleteFromDatabase(String key) throws DatabaseException {
